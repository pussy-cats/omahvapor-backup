            ...
            <table class="table table-striped table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center"><a href="{{ route('cartQuantityAdd', ['id' => $cart->id]) }}" class="btn btn-primary">Tambah Qty</a></td>
                        <td class="text-center"><a href="{{ route('cartQuantityMinus', ['id' => $cart->id]) }}" class="btn btn-warning">Minus Qty</a></td>
